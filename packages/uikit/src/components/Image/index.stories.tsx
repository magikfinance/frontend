...
export const TokenImages: React.FC = () => {
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        const src = `https://magikswap.dog/images/tokens/${token.address[56]}.png`;
  ...
  return (
    <Flex flexWrap="wrap">
      {tokens.map((token) => {
        ...
        const primarySrc = `https://magikswap.dog/images/tokens/${token.address[56]}.png`;
        const secondarySrc = `https://magikswap.dog/images/tokens/${tokens[randomTokenIndex].address[56]}.png`;
